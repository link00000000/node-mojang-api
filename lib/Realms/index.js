    ...
    async getIP(world)
    {
        return new Promise(async (resolve, reject) => {
            ...
            request({
                ...
                if(res.statusCode != 200)
                {
                    throw new Error("request to /worlds/v1/" + world.id + "/join/pc resulting in error " + res.statusCode + "\n" + JSON.stringify(body));
                }
    ...
    async getBackups(world)
    {
        return new Promise(async (resolve, reject) => {
            ...
            request({
                ...
                if(res.statusCode != 200)
                {
                    throw new Error("request to /worlds/" + world.id + "/backups resulting in error " + res.statusCode + "\n" + JSON.stringify(body));
                }
    ...
    async getDownload(world)
    {
        return new Promise(async (resolve, reject) => {
            ...
            request({
                ...
                if(res.statusCode != 200)
                {
                    throw new Error("request to /worlds/" + world.id + "/slot/" + world.activeSlot + "/download resulting in error " + res.statusCode + "\n" + JSON.stringify(body));
                }
    ...
    async getOPs(world)
    {
        return new Promise(async (resolve, reject) => {
            ...
            request({
                ...
                if(res.statusCode != 200)
                {
                    throw new Error("request to /ops/" + world.id + " resulting in error " + res.statusCode + "\n" + JSON.stringify(body));
                }
    ...
    async getSubscription(world)
    {
        return new Promise(async (resolve, reject) => {
            ...
            request({
                ...
                if(res.statusCode != 200)
                {
                    throw new Error("request to /subscriptions/" + world.id + " resulting in error " + res.statusCode + "\n" + JSON.stringify(body));
                }
                resolve(JSON.parse(body));
            });
        });
    ...
    async getPendingInvites()
    {
        return new Promise(async (resolve, reject) => {
            ...
            request({
                ...
                if(res.statusCode != 200)
                {
                    throw new Error("request to /invites/count/pending resulting in error " + res.statusCode + "\n" + JSON.stringify(body));
                }
